...
import BarcodeScanner from "../Screens/BarcodeView";
...
export const MyStack = () => {
  ...
  if (loginState.isLoading) {
    ...
    <View style={{backgroundColor:color.backgroundBlack, flex: 1, justifyContent: "center"}}>
        <Text
          style={{
            color: '#fff',
            fontSize: 32,
  ...
  const [tabRoute, setTabRoute] = useState('Home');
    ...
    return (
        <Tab.Navigator screenOptions={{tabBarShowLabel: false}}>
            <Tab.Screen name="Home" component={HomeScreen} options={{tabBarActiveTintColor: color.black, title: 'Home', 
                headerStyle: CustomStyling.NavBarHeaderStyle,
                tabBarIcon: ({focused}) => (
                      <Image source={require("../images/homeBar.png")} style={{width: 24, height: 24, resizeMode: "contain",
            ...
            <Tab.Screen name="Profile" component={ProfileView} options={{tabBarActiveTintColor: color.black, title: 'Profile', headerStyle: CustomStyling.NavBarHeaderStyle,
                tabBarIcon: ({focused}) => (
                      <Image source={require("../images/profileBar.png")} style={{width: 24, height: 24, resizeMode: "contain", 
                      tintColor: (focused) ? color.backgroundBlack : color.darkGray}}/>
                  ), headerTitleStyle:{color:"white", fontFamily: fonts.semiBold,
                  fontSize: 20,}}}
            />
