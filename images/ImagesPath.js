 module.exports = {
     ...
     attachmentImg: require('../images/attachment.png'),
     clockImg: require('../images/clock.png'),
     plainCalendarImg: require('../images/calendar.png'),
     emailImg: require('../images/email.png'),
     phoneImg: require('../images/phone.png'),
     descriptionImg: require('../images/description.png'),
     subjectImg: require('../images/subject.png'),
     activeUserImg: require('../images/personActive.png'),
     lockImg: require('../images/lock.png'),
     meetingImg: require('../images/meeting.jpg'),
     radioBtnOnImg: require('../images/RadioBtnOn.png'),
     radioBtnOffImg: require('../images/RadioBtnOff.png'),
     filterImg: require('../images/filter.png'),
     backImg: require('../images/back.png'),
 }